...
$(function() {
    window.config.dateFormatDisplay = window.config.dateFormat
        .replace('M/d/yyyy', 'MM/DD/YYYY')
        .replace('d/M/yyyy', 'DD/MM/YYYY').toUpperCase();
    ...
    $(document).on('shown.bs.modal', function (e) {
        ...
        $('input.date', modal).mask('00/00/0000');
    });
...
function viewLetterPdf(id) {
    ...
    var url = config.basePath + 'Student/Letters/Read/' + id + '?iframe=True';
        ...
        var modal = bootbox.dialog({
            ...
            buttons: {
                ...
                No: {
                    ...
                    className: opt.noClass || 'btn-default',
                    callback: function () {
